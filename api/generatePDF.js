...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const start = formatEpochMsToLongDate(data.course_start_date, { timeZone: 'America/Toronto' });
    const end = formatEpochMsToLongDate(data.course_end_date, { timeZone: 'America/Toronto' });
        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            footer { background-color: #45D3B9; color: #01386E; padding: 1rem 2rem; margin-top: -1rem; }
